(function ( $ ) {
	...
	$.fn.BootSideMenu = function( options ) {
		...
		newCode += "<img class=\"icon\" src=\"/images/menu_icon.png\" /><img class=\"cross\" src=\"/images/cross_icon2.png\" style=\"display:none;\"/>";
		newCode += "</div>\n";
...
function toggleArrow(toggler, side){
	if(side=="left"){
		$(toggler).children(".cross").css('display', 'block');
		$(toggler).children(".icon").css('display', 'none');
	}else if(side=="right"){
		$(toggler).children(".icon").css('display', 'block');
		$(toggler).children(".cross").css('display', 'none');
	}
}
